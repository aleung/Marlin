...
// deltas need the same for all three axes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH         8  // (mm) An unretract is done, then this length is purged.
                                                  // ram purge: extrude an amount of filament at high feedrate that it doesn't
                                                  // have time to melt, to clear out heat chamfer and do a very quick retract
